...
final class MockMediaManager implements MediaManagerInterface
{
    ...
    public function getById($id, $locale) { return null; }
    public function save($uploadedFile, $data, $userId) { return null; }
    public function delete($id, $checkSecurity = false) {}
    public function move($id, $locale, $destCollection) { return null; }
    public function increaseDownloadCounter($fileVersionId) {}
    public function addFormatsAndUrl(\Sulu\Bundle\MediaBundle\Api\Media $media) { return $media; }
    public function getByIds(array $ids, $locale) { return []; }
    public function getUrl($id, $fileName, $version) { return ''; }
    public function getCount() { return 0; }
    public function getEntityById($id) { return null; }
    public function getFormatUrls($ids, $locale) { return []; }
